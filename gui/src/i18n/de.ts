...
export const de = {
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "cws.overviewBlurb": "Virtuelle Modelle, die unter Anbieter/Modell-Zielen wählen — Failover bei Limits und Plan-Sperren oder sticky gewichtetes Round-Robin.",
  "cws.count.total": "Gesamt",
  "cws.count.failover": "Failover",
  "cws.count.roundRobin": "Round-Robin",
  "cws.howTitle": "So funktioniert es",
  "cws.howBody": "In Codex combo/<id> anfragen. OpenCodex wählt ein Ziel und springt bei wiederholbaren Upstream-Fehlern (429, 5xx, Abo-403) nach kurzer Abkühlung zum nächsten Mitglied.",
  ...
  "cws.strategy.roundRobinHint": "Last auf die Ziele verteilen. Nach mehreren Erfolgen auf einem Ziel rotieren; höhere Gewichte werden öfter gewählt.",
  ...
  "cws.field.stickyLimitHint": "So viele erfolgreiche Antworten auf dem gewählten Ziel bleiben, dann rotieren.",
  "cws.field.defaultEffort": "Standard-Reasoning",
  "cws.field.defaultEffortHint": "Wenn der Client kein Reasoning-Level sendet und das gewählte Ziel Reasoning unterstützt. Client-Werte haben Vorrang; Modelle ohne Effort-Steuerung bleiben unberührt.",
  "cws.targets": "Ziele",
  "cws.targets.failoverHint": "Reihenfolge zählt — das erste ist primär.",
  "cws.targets.roundRobinHint": "Gewichte steuern den Anteil; Reihenfolge ist der Rotationsring.",
  ...
  "cws.aboutBody": "Fehlgeschlagene Ziele kühlen kurz ab (Retry-After wird beachtet). Harte Stops — Kontextlänge und ungültige Anfragen — springen nicht. Sticky-Status wird beim Speichern zurückgesetzt.",
