...
const CONNECTABLE: Record<string, ConnectableOverride> = {
  ...
  "glm-cn": openAi("https://open.bigmodel.cn/api/coding/paas/v4", "https://bigmodel.cn/apikey/platform", { supportLevel: "supported", verification: "official", documentationUrl: "https://docs.bigmodel.cn/cn/api/introduction", discovery: "static", liveModels: false, models: ["glm-4.7-flash"] }),
