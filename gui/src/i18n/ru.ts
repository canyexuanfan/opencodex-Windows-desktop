...
export const ru: Record<TKey, string> = {
  ...
  "pws.rateLimits.documented": "Документировано",
  "pws.rateLimits.rpm": "{value} запр./мин",
  "pws.rateLimits.tpm": "{value} токенов/мин",
  "pws.rateLimits.rpd": "{value} запр./день",
  "pws.rateLimits.freeTier.local": "Локально — удалённых лимитов нет",
  "pws.rateLimits.freeTier.opencodeFree": "~200 бесплатных запросов моделей за 5 часов",
  "pws.rateLimits.freeTier.gemini": "Бесплатно: ~15 RPM / 250K TPM / 1K RPD (зависит от тарифа)",
  "pws.rateLimits.freeTier.groq": "Бесплатно: ~30 RPM / 6K TPM / 1K RPD",
  "pws.rateLimits.freeTier.sambanova": "Бесплатно: ~60 RPM / 100K TPM; далее оплата по факту",
  "pws.rateLimits.freeTier.nebius": "Бесплатно: ~50 RPM / 50K TPM",
  "pws.rateLimits.freeTier.mistral": "Бесплатно: ~5 RPM / 20K TPM; далее оплата по факту",
  "pws.rateLimits.freeTier.together": "Бесплатно: ~60 RPM / 1M TPM; далее оплата по факту",
  "pws.rateLimits.freeTier.fireworks": "Бесплатно: ~600 RPM / 150K TPM",
  "pws.rateLimits.freeTier.openrouter": "Бесплатные модели: ~20 запр./мин, ограничение по кредитам; платные — за модель",
  "pws.rateLimits.freeTier.minimax": "Подписка Coding Plan; квоты по тарифу",
  "pws.rateLimits.freeTier.zai": "Подписка GLM Coding (платная)",
  "pws.rateLimits.freeTier.deepseek": "Новые аккаунты: разовый грант токенов; далее оплата по факту",
