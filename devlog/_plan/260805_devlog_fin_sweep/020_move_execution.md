...
| `devlog/_plan/260803_pr_issue_sweep/000_plan.md:100`, `040_phase4_backlog_disposition.md:122` | `260803_sparse_snapshot_repair` |
| `devlog/_plan/260804_router_intelligence/000_master_plan.md:89` | `260730_kiro_usage_cumulative_cache` (`:90` cites `260804_stacked_pr_ci`, which stays — do NOT edit that line) |
| `devlog/_plan/260805_issue_pr_triage/001_prior_investigation_index.md:70,73` | `260803_bug_backlog_stack`, `260802_issue_pr_triage` |
...
for u in $(cat move-list); do
  rg -n "devlog/_plan/$u" . \
    ...
    --glob '!devlog/_plan/260805_devlog_fin_sweep/**' --glob '!.git'
done
```
...
5. Verify: `repo-hygiene`, `privacy:scan`, gitlink check, `rg` for stale paths,
   ...
   - `devlog/_plan/260805_devlog_fin_sweep/020_move_execution.md` — this file.
