...
export const en = {
  ...
  "claude.autoCompactWindowDesc": "Older messages are summarized when the chat reaches this point. One value, but Claude applies min(model limit, this value) per model — 200k models are unaffected.",
