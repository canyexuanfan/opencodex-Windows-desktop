...
export const zh: Record<TKey, string> = {
  ...
  "models.v2On": "已开启 — v2 多代理界面激活",
  "models.v2Off": "已关闭 — v1 多代理界面（安装默认值）",
  "models.v2Mode_v1": "全部 v1",
  "models.v2Mode_default": "默认",
  "models.v2Mode_v2": "全部 v2",
  "models.v2ModeDesc_v1": "所有模型强制使用 v1 界面",
  "models.v2ModeDesc_default": "保留上游固定值 (sol/terra=v2, luna=v1)",
  "models.v2ModeDesc_v2": "所有模型强制使用 v2 界面",
