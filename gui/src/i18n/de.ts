...
export const de: Record<TKey, string> = {
  ...
  "dash.actions": "Proxy",
  "dash.codexRestart": "Codex neu starten",
  "dash.codexRestarting": "Wird neu gestartet…",
  "dash.codexRestartConfirm": "Codex-App-Server neu starten? Ein laufender Codex-Durchlauf wird unterbrochen.",
