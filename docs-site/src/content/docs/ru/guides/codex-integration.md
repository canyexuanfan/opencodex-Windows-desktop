...
вышестоящей модели. По умолчанию в селекторе показывается последний сегмент нативного идентификатора
модели, поэтому пространство имён провайдера не скрывает имя модели в узком селекторе. Полный маршрут
`provider/model` сохраняется в slug и описании каталога. Если маршрут важно различать визуально
