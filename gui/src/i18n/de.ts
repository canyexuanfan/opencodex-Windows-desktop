...
export const de = {
  ...
  "claude.fastOn": "ON",
  "claude.fastOff": "OFF",
  "claude.maxContext": "Kontextgröße erhöhen",
  "claude.maxContextDesc": "Wie viele Tokens Claude im Gespräch behalten darf. Leer lassen für den Claude-Standard (meist 200k). Für 1M-Modelle z. B. 1000000.",
  "claude.maxContextWarn": "Schaltet auch die automatische Zusammenfassung langer Chats ab. Sehr lange Chats können am echten Modelllimit scheitern.",
  "claude.maxContextPlaceholder": "Standard",
  "claude.autoContext": "Großen Kontext automatisch nutzen",
  "claude.autoContextDesc": "Kann ein Modell mehr als 200k Tokens behalten (z. B. GPT-Modelle), wird dieser Platz automatisch genutzt. Erreicht der Chat den Punkt unten, werden ältere Nachrichten zusammengefasst und es geht weiter.",
  "claude.autoContextInert": "Pausiert, solange oben 'Kontextgröße erhöhen' gesetzt ist.",
  ...
  "claude.tierModelsHint": "Claude-Code-Subagenten wählen Modelle über Tier-Aliasse (opus / sonnet / haiku / fable). Lege fest, welches Modell jedes Tier bedeutet. haiku nutzt den Small/Fast-Slot oben. 1M-Kontext-Modelle werden automatisch markiert.",
  "claude.tier.opus": "opus-Tier",
  "claude.tier.sonnet": "sonnet-Tier",
  "claude.tier.fable": "fable-Tier",
  ...
  "claude.defaultModel": "Standardmodell",
  "claude.smallFastModel": "Schnelles Hilfsmodell",
  "claude.slotUnset": "Claude-Standard verwenden",
  "claude.modelMap": "Modell-Tausch",
  "claude.modelMapHint": "Wenn Claude ein bestimmtes Modell anfragt, wird es durch ein anderes ersetzt.",
