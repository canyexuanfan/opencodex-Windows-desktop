...
export const ko: Record<TKey, string> = {
  ...
  "models.v2On": "켜짐 — v2 멀티에이전트 서피스 활성",
  "models.v2Off": "꺼짐 — v1 멀티에이전트 서피스 (설치 기본값)",
  "models.v2Mode_v1": "전부 v1",
  "models.v2Mode_default": "기본값",
  "models.v2Mode_v2": "전부 v2",
  "models.v2ModeDesc_v1": "모든 모델 v1 서피스 강제",
  "models.v2ModeDesc_default": "업스트림 핀 유지 (sol/terra=v2, luna=v1)",
  "models.v2ModeDesc_v2": "모든 모델 v2 서피스 강제",
