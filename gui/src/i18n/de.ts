...
export const de: Record<TKey, string> = {
  ...
  "dash.syncCodexSubagentDefaultsHint": "Schreibt die Wahl von oben in Codex' eigene Konfiguration, damit neue Codex-Aufgaben mit diesem Modell starten. Wirksam beim nächsten Sync oder Neustart; deine selbst geschriebenen [agents]-Einstellungen bleiben unberührt. Standardmäßig aus.",
  "dash.multiAgentGuidance": "OpenCodex-Multi-Agent-Anleitung",
  "dash.multiAgentGuidanceHint": "Fügt dem Prompt einen kurzen Hinweis hinzu, wie das Modell Arbeit auf Sub-Agenten verteilen soll. Sonst ändert sich nichts: gleiche v1/v2-Oberfläche, gleiche Sub-Agent-Liste, gleiches Routing und gleiche Aufwandsgrenzen.",
