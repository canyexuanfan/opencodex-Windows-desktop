...
export const ja: Record<TKey, string> = {
  ...
  "dash.syncCodexSubagentDefaultsHint": "上で選んだモデルを Codex 自身の設定に書き込み、新しい Codex タスクがそのモデルで始まるようにします。次回の同期または再起動で反映され、自分で書いた [agents] 設定はそのまま残ります。既定はオフです。",
  "dash.multiAgentGuidance": "OpenCodex マルチエージェントガイダンス",
  "dash.multiAgentGuidanceHint": "作業をサブエージェントにどう分けるかを伝える短い案内をプロンプトに追加します。ほかは変わりません。v1/v2 サーフェス、サブエージェント一覧、ルーティング、effort 上限はそのままです。",
