...
export const zh: Record<TKey, string> = {
  ...
  "pws.rateLimits": "速率限制",
  "pws.rateLimits.documented": "文档记录",
  "pws.rateLimits.rpm": "{value} 次/分钟",
  "pws.rateLimits.tpm": "{value} 令牌/分钟",
  "pws.rateLimits.rpd": "{value} 次/天",
  "pws.rateLimits.freeTier.local": "本地 — 无远程限制",
  "pws.rateLimits.freeTier.opencodeFree": "每 5 小时约 200 次免费模型请求",
  "pws.rateLimits.freeTier.gemini": "免费: ~15 RPM / 250K TPM / 1K RPD（因套餐而异）",
  "pws.rateLimits.freeTier.groq": "免费: ~30 RPM / 6K TPM / 1K RPD",
  "pws.rateLimits.freeTier.sambanova": "免费: ~60 RPM / 100K TPM; 之后按量付费",
  "pws.rateLimits.freeTier.nebius": "免费: ~50 RPM / 50K TPM",
  "pws.rateLimits.freeTier.mistral": "免费: ~5 RPM / 20K TPM; 之后按量付费",
  "pws.rateLimits.freeTier.together": "免费: ~60 RPM / 1M TPM; 之后按量付费",
  "pws.rateLimits.freeTier.fireworks": "免费: ~600 RPM / 150K TPM",
  "pws.rateLimits.freeTier.openrouter": "免费模型: 约 20 次/分钟，有额度上限; 付费按模型计费",
  "pws.rateLimits.freeTier.minimax": "编码套餐订阅; 按套餐配额",
  "pws.rateLimits.freeTier.zai": "GLM 编码订阅（付费）",
  "pws.rateLimits.freeTier.deepseek": "新账户: 一次性令牌赠送; 之后按量付费",
