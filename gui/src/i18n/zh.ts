...
export const zh: Record<TKey, string> = {
  ...
  "integrations.summary.detected": "已检测",
  "integrations.summary.applied": "已应用",
  ...
  "integrations.error.nonLoopback": "{client} 只能连接 localhost 上的代理，因此 opencodex 不会写入会被拒绝的配置。远程绑定请手动配置。",
