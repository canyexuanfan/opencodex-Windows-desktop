...
| #796 | 6 | "leave open pending live Ark credential verification; structural fix `d3abf4345` + regression test already on dev" | `devlog/_plan/260805_bug_stack_campaign/130_dispositions.md:20` |
| #418 | 19 | "leave open; latest same-run trace does not reproduce; needs reporter's current trace" | `devlog/_plan/260805_bug_stack_campaign/130_dispositions.md:21` |
| #417 | 17 | bucketed as feature/provider/tracker/upstream | `devlog/_plan/260805_bug_stack_campaign/001_issue_triage.md:39` |
| #241 | 24 | bucketed as feature/provider/tracker/upstream | `devlog/_plan/260805_bug_stack_campaign/001_issue_triage.md:39` |
| #92 | 26 | bucketed as feature/provider/tracker/upstream | `devlog/_plan/260805_bug_stack_campaign/001_issue_triage.md:39` |
| #540 | 7 | bucketed as feature/provider/tracker/upstream | `devlog/_plan/260805_bug_stack_campaign/001_issue_triage.md:39` |
...
- **#904** — `eeef7a32a` claimed for surrogate boundaries
  (`devlog/_plan/260805_bug_stack_campaign/130_dispositions.md:19`).
- **#796** — `d3abf4345` claimed as a structural fix already on `dev`
  (`devlog/_plan/260805_bug_stack_campaign/130_dispositions.md:20`).
