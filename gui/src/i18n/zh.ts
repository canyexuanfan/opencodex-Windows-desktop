...
export const zh: Record<TKey, string> = {
  ...
  "claude.fastOn": "ON",
  "claude.fastOff": "OFF",
  "claude.maxContext": "扩大上下文长度",
  "claude.maxContextDesc": "Claude 在对话中可记住的 token 数。留空使用 Claude 默认值（通常 20 万）。1M 模型可填 1000000。",
  "claude.maxContextWarn": "长对话自动摘要也会被关闭。对话过长时可能触及模型真实上限并报错。",
  "claude.maxContextPlaceholder": "默认",
  "claude.autoContext": "自动利用大上下文",
  "claude.autoContextDesc": "决定 1M 标记的范围。开：所有超过 20 万 token 的模型（GPT 系列等）都有大上下文条目；关：仅真正的 1M 模型有。",
  "claude.autoContextInert": "上方设置了「扩大上下文长度」时，此功能暂停。",
  "claude.autoCompactWindow": "自动摘要触发点",
  "claude.autoCompactDefault": "350k（默认）",
  "claude.autoCompactWindowDesc": "对话达到该点时自动摘要旧内容。值只有一个，但 Claude 按每个模型取 min(模型上限, 该值)——200k 模型不受影响。",
  ...
  "claude.tierModelsHint": "Claude Code 子代理按层级别名（opus / sonnet / haiku / fable）选择模型。为每个别名指定路由模型。haiku 使用上方的小型/快速槽位。1M 上下文模型会自动标记。",
  "claude.tier.opus": "opus 层级",
  "claude.tier.sonnet": "sonnet 层级",
  "claude.tier.fable": "fable 层级",
  ...
  "claude.smallFastModel": "快速辅助模型",
  "claude.slotUnset": "使用 Claude 默认值",
  "claude.modelMap": "模型替换",
  "claude.modelMapHint": "当 Claude 请求某个模型时，替换为其他模型。",
