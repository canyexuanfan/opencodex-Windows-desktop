...
export const ko: Record<TKey, string> = {
  ...
  "claude.fastOn": "ON",
  "claude.fastOff": "OFF",
  "claude.maxContext": "컨텍스트 크기 늘리기",
  "claude.maxContextDesc": "Claude가 대화에서 기억할 수 있는 토큰 양입니다. 비워두면 Claude 기본값(보통 20만)을 씁니다. 1M 모델이면 1000000을 넣으세요.",
  "claude.maxContextWarn": "긴 대화 자동 요약도 함께 꺼집니다. 대화가 아주 길어지면 모델의 실제 한도에 걸려 오류가 날 수 있어요.",
  "claude.maxContextPlaceholder": "기본값",
  ...
  "claude.autoContextInert": "위의 '컨텍스트 크기 늘리기'가 설정되어 있는 동안은 이 기능이 잠시 쉽니다.",
  "claude.autoCompactWindow": "자동 요약 지점",
  "claude.autoCompactDefault": "350k (기본값)",
  "claude.autoCompactWindowDesc": "대화가 이 지점에 다다르면 오래된 내용을 자동 요약합니다. 값은 하나지만 Claude가 모델마다 min(모델 한도, 이 값)으로 계산해서 200k 모델은 영향받지 않아요.",
  ...
  "claude.tierModelsHint": "Claude Code 서브에이전트는 opus / sonnet / haiku / fable 별칭으로 모델을 고릅니다. 각 별칭이 어떤 모델을 뜻할지 정하세요. haiku는 위의 소형/고속 모델을 씁니다. 1M 컨텍스트 모델은 자동으로 표시돼요.",
  "claude.tier.opus": "opus 티어",
  "claude.tier.sonnet": "sonnet 티어",
  "claude.tier.fable": "fable 티어",
  ...
  "claude.defaultModel": "기본 모델",
  "claude.smallFastModel": "빠른 보조 모델",
  "claude.slotUnset": "Claude 기본값 사용",
  "claude.modelMap": "모델 바꾸기",
  "claude.modelMapHint": "Claude가 특정 모델을 요청하면 다른 모델로 바꿔서 보냅니다.",
