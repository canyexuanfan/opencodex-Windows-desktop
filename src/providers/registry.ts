...
// GLM (not glm-4.6) is the right default for this host's users. The fork list is a
// superset of upstream's, newest-first; upstream's only functional delta here was
// the note below.
...
// Union of the fork's domestic-endpoint ids and upstream's glm-5.3-flash (native VLM):
// both sides' reasoning-capable members keep the binary thinking knob.
const ZHIPU_BIGMODEL_THINKING_TOGGLE_MODELS = ["glm-5.3", "glm-5.2", "glm-5.1", "glm-5", "glm-5-turbo", "glm-5v-turbo", "glm-5.3-flash", "glm-4.7", "glm-4.6"];
