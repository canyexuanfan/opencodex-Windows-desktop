...
export const ko: Record<TKey, string> = {
  ...
  "pws.rateLimits.documented": "문서 기준",
  "pws.rateLimits.rpm": "{value} 회/분",
  "pws.rateLimits.tpm": "{value} 토큰/분",
  "pws.rateLimits.rpd": "{value} 회/일",
  "pws.rateLimits.freeTier.local": "로컬 — 원격 제한 없음",
  "pws.rateLimits.freeTier.opencodeFree": "5시간당 무료 모델 요청 약 200회",
  "pws.rateLimits.freeTier.gemini": "무료: ~15 RPM / 250K TPM / 1K RPD (플랜별 상이)",
  "pws.rateLimits.freeTier.groq": "무료: ~30 RPM / 6K TPM / 1K RPD",
  "pws.rateLimits.freeTier.sambanova": "무료: ~60 RPM / 100K TPM; 이후 종량제",
  "pws.rateLimits.freeTier.nebius": "무료: ~50 RPM / 50K TPM",
  "pws.rateLimits.freeTier.mistral": "무료: ~5 RPM / 20K TPM; 이후 종량제",
  "pws.rateLimits.freeTier.together": "무료: ~60 RPM / 1M TPM; 이후 종량제",
  "pws.rateLimits.freeTier.fireworks": "무료: ~600 RPM / 150K TPM",
  "pws.rateLimits.freeTier.openrouter": "무료 모델: 분당 약 20회, 크레딧 한도; 유료는 모델별",
  "pws.rateLimits.freeTier.minimax": "코딩 플랜 구독; 플랜별 할당량",
  "pws.rateLimits.freeTier.zai": "GLM 코딩 구독 (유료)",
  "pws.rateLimits.freeTier.deepseek": "신규 계정: 일회성 토큰 제공; 이후 종량제",
