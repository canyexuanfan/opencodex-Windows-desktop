...
export const de: Record<TKey, string> = {
  ...
  "pws.rateLimits.documented": "Dokumentiert",
  "pws.rateLimits.rpm": "{value} Anfragen/min",
  "pws.rateLimits.tpm": "{value} Tokens/min",
  "pws.rateLimits.rpd": "{value} Anfragen/Tag",
  "pws.rateLimits.freeTier.local": "Lokal — keine Remote-Limits",
  "pws.rateLimits.freeTier.opencodeFree": "~200 kostenlose Modell-Anfragen pro 5 Stunden",
  "pws.rateLimits.freeTier.gemini": "Kostenlos: ~15 RPM / 250K TPM / 1K RPD (stufenabhängig)",
  "pws.rateLimits.freeTier.groq": "Kostenlos: ~30 RPM / 6K TPM / 1K RPD",
  "pws.rateLimits.freeTier.sambanova": "Kostenlos: ~60 RPM / 100K TPM; dann Pay-as-you-go",
  "pws.rateLimits.freeTier.nebius": "Kostenlos: ~50 RPM / 50K TPM",
  "pws.rateLimits.freeTier.mistral": "Kostenlos: ~5 RPM / 20K TPM; dann Pay-as-you-go",
  "pws.rateLimits.freeTier.together": "Kostenlos: ~60 RPM / 1M TPM; dann Pay-as-you-go",
  "pws.rateLimits.freeTier.fireworks": "Kostenlos: ~600 RPM / 150K TPM",
  "pws.rateLimits.freeTier.openrouter": "Kostenlose Modelle: ~20 Anfragen/min, kreditbegrenzt; bezahlte pro Modell",
  "pws.rateLimits.freeTier.minimax": "Coding-Plan-Abo; planabhängige Kontingente",
  "pws.rateLimits.freeTier.zai": "GLM-Coding-Abo (kostenpflichtig)",
  "pws.rateLimits.freeTier.deepseek": "Neue Konten: einmaliges Token-Guthaben; dann Pay-as-you-go",
