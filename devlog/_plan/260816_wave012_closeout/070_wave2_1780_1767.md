...
Second, disambiguation must not push a valid candidate over the limit. Build candidates as `truncatedPrefix + "_" + fullHash` (+ collision suffix), never as a plain slice of the finished string:
