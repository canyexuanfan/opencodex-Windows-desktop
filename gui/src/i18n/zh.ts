...
export const zh: Record<TKey, string> = {
 ...
 "pws.noModelMatch": "没有匹配筛选的模型。",
  ...
  "cws.overviewBlurb": "在多个提供方/模型目标中选择的虚拟模型 — 限流与订阅门控时故障转移，或加权粘性轮询。",
  "cws.count.total": "总计",
  "cws.count.failover": "故障转移",
  "cws.count.roundRobin": "轮询",
  "cws.howTitle": "工作原理",
  "cws.howBody": "在 Codex 中请求 combo/<id>。OpenCodex 选择目标，并在可重试的上游错误（429、5xx、订阅 403）后短暂冷却并跳到下一个成员。",
  ...
  "cws.strategy.roundRobinHint": "在目标间分担流量。在同一目标连续成功若干次后轮换；权重越高被选中越多。",
  "cws.field.id": "组合 ID",
  "cws.field.idPlaceholder": "free",
  "cws.field.idHint": "客户端将请求 {model}",
  "cws.field.stickyLimit": "轮换前的粘性成功次数",
  "cws.field.stickyLimitHint": "在当前获胜目标上连续成功这么多次后再轮换。",
  "cws.field.defaultEffort": "默认推理级别",
  "cws.field.defaultEffortHint": "仅在客户端未指定推理级别、且所选目标支持推理时使用。客户端显式发送的级别始终优先；无推理控制的模型不会注入。",
  "cws.targets": "目标",
  "cws.targets.failoverHint": "顺序很重要 — 第一个为主。",
  "cws.targets.roundRobinHint": "权重控制相对流量；顺序是轮换环。",
  ...
  "cws.aboutTitle": "运行时",
  "cws.aboutBody": "失败目标会短暂冷却（尊重 Retry-After）。上下文长度与无效请求不会跳转。保存此组合时会重置粘性状态。",
