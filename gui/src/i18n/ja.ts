...
export const ja: Record<TKey, string> = {
  ...
  "codexAuth.switchDesc": "すぐに反映されます。処理中のリクエストは現在のアカウントを維持し、それ以外はこのアカウントに切り替わります。ただし同じ選択順序のアカウントは引き続き交代で使われます。",
  ...
  "codexAuth.switchBackDesc": "すぐに反映されます。処理中のリクエストは現在のアカウントを維持し、それ以外はアプリログインアカウントに切り替わります。ただし同じ選択順序のアカウントは引き続き交代で使われます。",
