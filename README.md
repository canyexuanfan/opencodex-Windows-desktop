...
This fork keeps Windows desktop packaging notes in this README and the release notes. Maintainer
source-of-truth notes live under [`structure/`](./structure), contributor setup in
