...
A natural-language "I understand" was explicitly not accepted as acknowledgement (080 §3); the bounded attempt did not even yield natural language, reinforcing that headless CLI is the wrong probe for structured ack.
