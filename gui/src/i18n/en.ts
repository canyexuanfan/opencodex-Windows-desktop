...
export const en = {
  ...
  "dash.syncCodexSubagentDefaultsHint": "Writes the pick above into Codex's own config, so new Codex tasks start with that model. It takes effect on the next sync or restart, and your hand-written [agents] settings are left alone. Off by default.",
  "dash.multiAgentGuidance": "OpenCodex multi-agent guidance",
  "dash.multiAgentGuidanceHint": "Adds a short note to the prompt telling the model how to split work across sub-agents. Nothing else changes: same v1/v2 surface, same sub-agent list, same routing and effort limits.",
