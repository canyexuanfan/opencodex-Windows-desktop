...
export const zh: Record<TKey, string> = {
  ...
  "dash.start": "开启代理",
  "dash.starting": "正在启动…",
  "dash.startFailed": "无法启动代理。",
  "dash.stop": "停止代理",
  "dash.externalManaged": "由外部 CLI 管理",
  "dash.stopConfirm": "停止代理并恢复原生 Codex 配置？",
  "dash.stopFailed": "无法停止代理 (HTTP {status})。",
  "dash.stopping": "正在停止…",
  "dash.codexAutoStart": "Codex CLI 启动时确保代理在线",
  "dash.codexAutoStartHint": "允许已安装的 CLI launcher shim 运行 ocx ensure；此开关不会安装 shim，也不覆盖 Codex Desktop 或直接 codex.exe。请在启动安全中安装/检查服务或 shim。",
  ...
  "dash.updateDesc": "检查所选通道；桌面端会检查 GitHub Releases 的 Windows 安装包，CLI 安装会检查包注册表。",
  "dash.updateChannel": "频道",
  "dash.updateChecking": "正在检查更新…",
  "dash.updateInstalled": "已安装",
  "dash.updateLatest": "最新",
  "dash.updateBuild": "（构建 {revision}）",
  "dash.updateAvailable": "有可用更新",
  "dash.updateCurrent": "已是最新",
  "dash.updateCommand": "命令",
  "dash.updateDesktopInstaller": "Windows 安装包",
  "dash.updateDesktopInstallerHint": "桌面端更新会从 fork 仓库下载并启动 Windows 安装程序；如提示，请先关闭当前 OpenCodex。",
  "dash.updateDownloadInstaller": "下载安装包",
  "dash.updateReleaseNotes": "发布页",
  "dash.updateSource": "当前是源码检出。请在终端运行显示的命令进行更新。",
  "dash.updateUnavailable": "无法从 npm 读取最新版本。请稍后重试。",
  "dash.updateDesktopReleaseUnavailable": "无法从 GitHub 读取最新桌面版发布。请稍后重试。",
  "dash.updateRetry": "重试",
  ...
  "dash.updateReason.desktop_release_unavailable": "无法读取 GitHub Release",
  "dash.updateReason.desktop_asset_missing": "最新发布缺少 Windows 安装包",
  "dash.updateReason.desktop_installer_manual": "需要下载并运行 Windows 安装包",
