...
export const en = {
  ...
  // Claude Code inbound
  "nav.claude": "Claude",
  "claude.subtitle": "Use any routed model from Claude Code — this proxy speaks the Anthropic Messages API on the same port.",
  ...
  "claude.slotUnset": "Keep Claude Code default",
  "claude.modelMap": "Model map",
  "claude.modelMapHint": "Rewrites inbound Anthropic model ids to routed models — exact id first, then with the date suffix stripped.",
  "claude.mapFrom": "Inbound id (e.g. claude-sonnet-4-5)",
  "claude.mapTo": "Routed model (e.g. gemini/gemini-3-pro)",
  "claude.addMapping": "Add mapping",
  "claude.removeMapping": "Remove mapping",
  "claude.aliases": "Picker aliases",
  "claude.aliasesHint": "Models Claude Code's /model picker discovers from this proxy (shown as \"From gateway\", Claude Code 2.1.129+).",
  ...
  "claude.toggleAria": "Toggle Claude inbound",
  "claude.none": "None",
} as const;
