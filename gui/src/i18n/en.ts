...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "codexAuth.switchDesc": "Takes effect immediately. Requests already in flight keep their captured account; everything else moves to this account, though accounts at the same selection order still take turns.",
  ...
  "codexAuth.switchBackDesc": "Takes effect immediately. Requests already in flight keep their captured account; everything else moves to your App login account, though accounts at the same selection order still take turns.",
