...
export const ko: Record<TKey, string> = {
  ...
  "prov.removedDefault": "\"{name}\"을(를) 삭제했습니다. 이제 기본 제공자는 \"{defaultProvider}\"입니다.",
  "prov.removeFail": "\"{name}\" 삭제에 실패했습니다.",
  "prov.removeLastProvider": "유일하게 구성된 제공자는 삭제할 수 없습니다.",
  "prov.removeHasDependentCombos": "먼저 이 제공자를 사용하는 콤보를 삭제하거나 수정하세요: {combos}.",
  "prov.setDefault": "기본으로 설정",
  "prov.setDefaultSuccess": "\"{name}\"이(가) 기본 제공자로 설정되었습니다.",
  "prov.setDefaultFail": "\"{name}\"을(를) 기본 제공자로 설정하지 못했습니다.",
  "prov.defaultDisabled": "기본으로 설정하려면 먼저 이 제공자를 활성화하세요.",
  "prov.updateFail": "이 제공자를 업데이트하지 못했습니다.",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "pws.removeDefaultConfirmBody": "기본 제공자 \"{name}\"을(를) 제거하시겠습니까? \"{defaultProvider}\"이(가) 기본 제공자가 됩니다. 이 작업은 되돌릴 수 없습니다.",
