...
export const ko: Record<TKey, string> = {
  ...
  "codexAuth.switchDesc": "즉시 적용됩니다. 이미 진행 중인 요청은 기존 계정을 유지하고, 그 외에는 이 계정으로 전환됩니다. 다만 같은 선택 순서의 계정은 계속 번갈아 사용됩니다.",
  "codexAuth.cacheWarning": "계정 전환 시 프롬프트 캐시가 초기화됩니다.",
  "codexAuth.setAsNext": "이 계정을 다음에 사용",
  "codexAuth.cancel": "취소",
  "codexAuth.switchBack": "메인 계정으로 돌아가시겠습니까?",
  "codexAuth.switchBackDesc": "즉시 적용됩니다. 이미 진행 중인 요청은 기존 계정을 유지하고, 그 외에는 앱 로그인 계정으로 전환됩니다. 다만 같은 선택 순서의 계정은 계속 번갈아 사용됩니다.",
