...
export const en = {
  ...
  "routing.compatibility.loadingCatalog": "Loading lab catalogue…",
  "routing.compatibility.catalogUnavailable": "Lab catalogue unavailable — enter suite ids manually in config.json.",
