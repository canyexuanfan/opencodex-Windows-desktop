...
export const ja: Record<TKey, string> = {
  ...
  "pws.rateLimits.documented": "ドキュメント記載",
  "pws.rateLimits.rpm": "{value} 回/分",
  "pws.rateLimits.tpm": "{value} トークン/分",
  "pws.rateLimits.rpd": "{value} 回/日",
  "pws.rateLimits.freeTier.local": "ローカル — リモート制限なし",
  "pws.rateLimits.freeTier.opencodeFree": "5時間あたり約200回の無料モデルリクエスト",
  "pws.rateLimits.freeTier.gemini": "無料: ~15 RPM / 250K TPM / 1K RPD (プランにより変動)",
  "pws.rateLimits.freeTier.groq": "無料: ~30 RPM / 6K TPM / 1K RPD",
  "pws.rateLimits.freeTier.sambanova": "無料: ~60 RPM / 100K TPM; 以降は従量課金",
  "pws.rateLimits.freeTier.nebius": "無料: ~50 RPM / 50K TPM",
  "pws.rateLimits.freeTier.mistral": "無料: ~5 RPM / 20K TPM; 以降は従量課金",
  "pws.rateLimits.freeTier.together": "無料: ~60 RPM / 1M TPM; 以降は従量課金",
  "pws.rateLimits.freeTier.fireworks": "無料: ~600 RPM / 150K TPM",
  "pws.rateLimits.freeTier.openrouter": "無料モデル: ~20 回/分、クレジット上限あり; 有料はモデル別",
  "pws.rateLimits.freeTier.minimax": "コーディングプラン定額; プラン別クォータ",
  "pws.rateLimits.freeTier.zai": "GLMコーディング定額 (有料)",
  "pws.rateLimits.freeTier.deepseek": "新規アカウント: 一度きりのトークン付与; 以降は従量課金",
