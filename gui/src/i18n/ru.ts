...
export const ru: Record<TKey, string> = {
  ...
  "dash.start": "Запустить прокси",
  "dash.starting": "Запуск…",
  "dash.startFailed": "Не удалось запустить прокси.",
  ...
  "dash.codexAutoStart": "Проверять прокси при запуске Codex CLI",
  "dash.codexAutoStartHint": "Разрешает установленному CLI launcher shim выполнять ocx ensure. Этот переключатель не устанавливает shim и не покрывает Codex Desktop или прямой запуск codex.exe; проверьте службу/shim в безопасности запуска.",
