...
export const en = {
  ...
  "dash.start": "Start Proxy",
  "dash.starting": "Starting…",
  "dash.startFailed": "Failed to start proxy.",
  ...
  "dash.codexAutoStart": "Ensure proxy when Codex CLI starts",
  "dash.codexAutoStartHint": "Allows an installed CLI launcher shim to run ocx ensure. This switch does not install the shim and does not cover Codex Desktop or direct codex.exe launches; use Startup safety to install/check service or shim.",
