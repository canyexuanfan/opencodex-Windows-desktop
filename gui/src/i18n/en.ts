...
export const en = {
  ...
  "claude.maxContextDesc": "How many tokens Claude may keep in a conversation. Leave empty to use Claude's default (usually 200k). Example: 1000000 for 1M-context models.",
  "claude.maxContextWarn": "This also turns off auto-summarizing of long chats. Very long chats may hit the model's real limit and error.",
  "claude.maxContextPlaceholder": "default",
  "claude.autoContext": "Use big context automatically",
  "claude.autoContextDesc": "When a model can remember more than 200k tokens (like GPT models), that room is used automatically. When the chat reaches the point below, older messages are summarized and the chat continues.",
  "claude.autoContextInert": "Paused while 'Context size override' above is set.",
  ...
  "claude.tierModelsHint": "Claude Code subagents pick models by tier alias (opus / sonnet / haiku / fable). Choose which routed model each tier means. Haiku uses the small/fast slot above. 1M-context models are marked automatically.",
  ...
  "claude.defaultModel": "Default model",
  "claude.smallFastModel": "Fast helper model",
  "claude.slotUnset": "Use Claude default",
  "claude.modelMap": "Model swap",
  "claude.modelMapHint": "When Claude requests a specific model, swap it for a different one.",
