...
export const ko: Record<TKey, string> = {
  ...
  "claude.slotUnset": "Claude Code 기본값 유지",
  "claude.modelMap": "모델 매핑",
  "claude.modelMapHint": "인바운드 Anthropic 모델 id를 라우팅 모델로 재작성합니다 — 정확한 id 우선, 그다음 날짜 접미사를 제거해 매칭합니다.",
  "claude.mapFrom": "인바운드 id (예: claude-sonnet-4-5)",
  "claude.mapTo": "라우팅 모델 (예: gemini/gemini-3-pro)",
  "claude.addMapping": "매핑 추가",
  "claude.removeMapping": "매핑 삭제",
  "claude.aliases": "피커 별칭",
  "claude.aliasesHint": "Claude Code의 /model 피커가 이 프록시에서 발견하는 모델 목록입니다 (\"From gateway\"로 표시, Claude Code 2.1.129+).",
