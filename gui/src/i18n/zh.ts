...
export const zh: Record<TKey, string> = {
  ...
  "dash.stopping": "正在停止…",
  "dash.actions": "代理",
  "dash.codexRestart": "重启 Codex",
  "dash.codexRestarting": "正在重启…",
  "dash.codexRestartConfirm": "要重启 Codex app-server 吗？正在进行的 Codex 任务会被中断。",
  ...
  "dash.codexRestartFailed": "重启 Codex 失败 (HTTP {status})。",
