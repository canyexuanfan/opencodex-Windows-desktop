...
export const en = {
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "cws.overviewBlurb": "Virtual models that pick among provider/model targets — failover on rate limits and plan gates, or sticky weighted round-robin.",
  "cws.count.total": "Total",
  "cws.count.failover": "Failover",
  "cws.count.roundRobin": "Round-robin",
  "cws.howTitle": "How it works",
  "cws.howBody": "Ask Codex for combo/<id>. OpenCodex picks a target, and on retryable upstream failures (429, 5xx, subscription 403) hops to the next member after a short cooldown.",
  ...
  "cws.strategy.roundRobinHint": "Spread traffic across targets. After a run of successes on one target, rotate to another; higher weights get picked more often.",
  ...
  "cws.field.stickyLimitHint": "Stay on the winning target for this many successful replies, then rotate.",
  "cws.field.defaultEffort": "Default reasoning",
  "cws.field.defaultEffortHint": "Used when the client omits a reasoning level and the picked target supports reasoning. Client-sent effort always wins; skipped for models with no effort control.",
  "cws.targets": "Targets",
  "cws.targets.failoverHint": "Order matters — first is primary.",
  "cws.targets.roundRobinHint": "Weights control relative traffic; order is the rotation ring.",
  ...
  "cws.aboutBody": "Failed targets cool down briefly (honoring Retry-After when present). Hard stops — context length and invalid requests — do not hop. Sticky state resets when you save this combo.",
