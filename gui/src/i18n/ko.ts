...
export const ko: Record<TKey, string> = {
  ...
  "models.contextHint": "이 프로바이더의 실제 Codex 창입니다. 업스트림이 context_window / context_length 를 주지 않으면 이 값을 쓰고, 더 큰 보고값이 있을 때만 낮춥니다. 비우면 자동 검색으로 돌아갑니다.",
  ...
  "models.setAll": "전체 적용",
  "models.setAllHint": "{value} 컨텍스트 상한을 라우팅된 모든 프로바이더에 적용합니다. 중계가 창을 주지 않으면 이 값이 실제 Codex 창이 됩니다. 네이티브 프로바이더는 영향을 받지 않습니다.",
