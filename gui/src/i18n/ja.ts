...
export const ja: Record<TKey, string> = {
  ...
  "dash.start": "プロキシを起動",
  "dash.starting": "起動中…",
  "dash.startFailed": "プロキシを起動できませんでした。",
  "dash.stop": "プロキシを停止",
  "dash.externalManaged": "外部 CLI が管理",
  "dash.stopConfirm": "プロキシを停止してネイティブの Codex に戻しますか?",
  "dash.stopFailed": "プロキシを停止できませんでした (HTTP {status})。",
  "dash.stopping": "停止中…",
  "dash.codexAutoStart": "Codex CLI 起動時にプロキシを確保",
  "dash.codexAutoStartHint": "インストール済みの CLI launcher shim に ocx ensure の実行を許可します。このスイッチは shim をインストールせず、Codex Desktop や直接 codex.exe 起動は対象外です。起動安全性でサービス/shim を確認してください。",
