...
export function corsHeaders(req?: Request, config?: OcxConfig): Record<string, string> {
  ...
  return {
    ...
    // (direct forward auth matches the bearer to this account id).
    "Access-Control-Allow-Headers": "Content-Type, Authorization, X-OpenCodex-API-Key, X-Api-Key, Anthropic-Version, Anthropic-Beta, ChatGPT-Account-Id",
    "Vary": "Origin",
  };
}
