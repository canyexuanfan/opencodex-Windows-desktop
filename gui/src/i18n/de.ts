...
export const de = {
  ...
  "claude.autoCompactWindowDesc": "Ältere Nachrichten werden an diesem Punkt zusammengefasst. Ein Wert, aber Claude rechnet pro Modell min(Modelllimit, Wert) — 200k-Modelle bleiben unberührt.",
