...
![Codex çoklu hesap yönlendirmesi: mevcut iş parçacıkları aynı ChatGPT hesabını korurken, yeni oturumlar kotayı yenileyebilir ve daha düşük kullanımlı sağlıklı bir hesap seçebilir.](../../../../assets/multi-auth-routing.svg)
