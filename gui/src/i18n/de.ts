...
export const de = {
  ...
  "claude.slotUnset": "Claude-Code-Standard behalten",
  "claude.modelMap": "Modell-Zuordnung",
  "claude.modelMapHint": "Schreibt eingehende Anthropic-Modell-IDs auf geroutete Modelle um — exakte ID zuerst, dann ohne Datumssuffix.",
  "claude.mapFrom": "Eingehende ID (z. B. claude-sonnet-4-5)",
  "claude.mapTo": "Geroutetes Modell (z. B. gemini/gemini-3-pro)",
  "claude.addMapping": "Zuordnung hinzufügen",
  "claude.removeMapping": "Zuordnung entfernen",
  "claude.aliases": "Picker-Aliasse",
  "claude.aliasesHint": "Modelle, die der /model-Picker von Claude Code über diesen Proxy findet (als \"From gateway\" angezeigt, Claude Code 2.1.129+).",
  "claude.loading": "Lädt…",
  ...
  "claude.toggleAria": "Claude-Inbound umschalten",
  "claude.none": "Keine",
} as const;
