...
export const PROVIDER_REGISTRY: readonly ProviderRegistryEntry[] = [
  ...
  },
  {
    ...
    note: "Experimental Cursor bridge. Live transport and native read/write/delete/shell execution are enabled when a Cursor access token is configured; OAuth remains disabled.",
