...
export const de: Record<TKey, string> = {
  ...
  "dash.start": "Proxy starten",
  "dash.starting": "Wird gestartet…",
  "dash.startFailed": "Proxy konnte nicht gestartet werden.",
  ...
  "dash.codexAutoStart": "Proxy beim Codex-CLI-Start sicherstellen",
  "dash.codexAutoStartHint": "Erlaubt einem installierten CLI-Launcher-Shim, ocx ensure auszuführen. Dieser Schalter installiert keinen Shim und deckt Codex Desktop oder direktes codex.exe nicht ab; nutze Startsicherheit für Dienst/Shim.",
  ...
  "dash.updateDesc": "Check the selected channel. Desktop builds check the Windows installer on GitHub Releases; CLI installs check the package registry.",
  ...
  "dash.updateDesktopInstaller": "Windows installer",
  "dash.updateDesktopInstallerHint": "Desktop updates are delivered as Windows setup packages from the fork repository. Download the installer, then run it to upgrade.",
  "dash.updateDownloadInstaller": "Download installer",
  "dash.updateReleaseNotes": "Release notes",
  ...
  "dash.updateDesktopReleaseUnavailable": "Could not read the latest desktop release from GitHub. Try again later.",
  ...
  "dash.updateReason.desktop_release_unavailable": "GitHub release unavailable",
  "dash.updateReason.desktop_asset_missing": "Windows installer missing from the latest release",
  "dash.updateReason.desktop_installer_manual": "download and run the Windows installer",
