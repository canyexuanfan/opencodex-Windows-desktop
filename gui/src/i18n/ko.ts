...
export const ko: Record<TKey, string> = {
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "cws.overviewBlurb": "프로바이더/모델 대상 중 하나를 고르는 가상 모델 — 한도·구독 게이트에서는 장애 조치, 또는 가중 라운드로빈.",
  "cws.count.total": "전체",
  "cws.count.failover": "장애 조치",
  "cws.count.roundRobin": "라운드로빈",
  "cws.howTitle": "동작 방식",
  "cws.howBody": "Codex에서 combo/<id>를 요청하세요. OpenCodex가 대상을 고르고, 재시도 가능한 업스트림 오류(429, 5xx, 구독 403)에서는 짧은 쿨다운 후 다음 멤버로 넘깁니다.",
  ...
  "cws.strategy.roundRobinHint": "대상에 트래픽을 나눕니다. 한 대상에서 연속 성공 후 다른 대상으로 회전하며, 가중치가 높을수록 더 자주 선택됩니다.",
  "cws.field.id": "콤보 ID",
  "cws.field.idPlaceholder": "free",
  "cws.field.idHint": "클라이언트는 {model}을(를) 요청합니다",
  "cws.field.stickyLimit": "회전 전 sticky 성공 횟수",
  "cws.field.stickyLimitHint": "선택된 대상에서 이 횟수만큼 성공한 뒤 회전합니다.",
  "cws.field.defaultEffort": "기본 추론 수준",
  "cws.field.defaultEffortHint": "클라이언트가 추론 수준을 생략했고 선택된 대상이 추론을 지원할 때만 사용합니다. 클라이언트가 보낸 값이 항상 우선하며, 노력 제어가 없는 모델에는 적용하지 않습니다.",
  "cws.targets": "대상",
  "cws.targets.failoverHint": "순서가 중요합니다 — 첫 번째가 기본입니다.",
  "cws.targets.roundRobinHint": "가중치는 상대 트래픽을, 순서는 회전 고리를 정합니다.",
  ...
  "cws.aboutTitle": "런타임",
  "cws.aboutBody": "실패한 대상은 잠시 쿨다운됩니다(Retry-After 존중). 컨텍스트 길이·잘못된 요청은 hop하지 않습니다. 저장 시 sticky 상태가 초기화됩니다.",
