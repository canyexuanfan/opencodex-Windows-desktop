...
export const zh: Record<TKey, string> = {
  ...
  "dash.syncCodexSubagentDefaultsHint": "把上面选的模型写进 Codex 自己的配置，让新的 Codex 任务一开始就用它。下次同步或重启后生效，你手写的 [agents] 设置不会被改动。默认关闭。",
  "dash.multiAgentGuidance": "OpenCodex 多代理指引",
  "dash.multiAgentGuidanceHint": "在提示中加一段简短说明，告诉模型怎么把工作分给子代理。其他都不变：v1/v2 界面、子代理清单、路由和 effort 上限都保持原样。",
