...
export const en = {
  ...
  "models.v2Label": "multi_agent_v2",
  "models.v2On": "ON — v2 multi-agent surface active",
  "models.v2Off": "OFF — v1 multi-agent surface (default install)",
  "models.v2Mode_v1": "All v1",
  "models.v2Mode_default": "Default",
  "models.v2Mode_v2": "All v2",
  "models.v2ModeDesc_v1": "All models forced to v1 surface",
  "models.v2ModeDesc_default": "Upstream pins respected (sol/terra=v2, luna=v1)",
  "models.v2ModeDesc_v2": "All models forced to v2 surface",
