...
export const en = {
  ...
  "dash.updateDesktopInstallerHint": "The update downloads and launches the Windows installer from the fork repository. Close OpenCodex if the installer asks.",
