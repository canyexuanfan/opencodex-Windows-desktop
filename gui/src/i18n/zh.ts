...
export const zh: Record<TKey, string> = {
  ...
  "claude.slotUnset": "保留 Claude Code 默认值",
  "claude.modelMap": "模型映射",
  "claude.modelMapHint": "将入站 Anthropic 模型 id 重写为路由模型 — 优先精确匹配，其次去掉日期后缀匹配。",
  "claude.mapFrom": "入站 id（如 claude-sonnet-4-5）",
  "claude.mapTo": "路由模型（如 gemini/gemini-3-pro）",
  "claude.addMapping": "添加映射",
  "claude.removeMapping": "删除映射",
  "claude.aliases": "选择器别名",
  "claude.aliasesHint": "Claude Code 的 /model 选择器从本代理发现的模型（显示为 \"From gateway\"，Claude Code 2.1.129+）。",
  "claude.loading": "加载中…",
  "claude.loadFail": "加载 Claude 设置失败",
  "claude.saved": "已保存。",
  "claude.saveFailed": "保存失败",
  "claude.networkError": "网络错误 — 代理是否在运行？",
  "claude.toggleAria": "切换 Claude 入站",
  "claude.none": "无",
};
