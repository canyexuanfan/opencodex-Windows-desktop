...
export const ru: Record<TKey, string> = {
  ...
  "dash.actions": "Прокси",
  "dash.codexRestart": "Перезапустить Codex",
  "dash.codexRestarting": "Перезапуск…",
  "dash.codexRestartConfirm": "Перезапустить app-server Codex? Текущая задача Codex будет прервана.",
