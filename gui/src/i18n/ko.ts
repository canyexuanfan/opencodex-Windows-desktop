...
export const ko: Record<TKey, string> = {
  ...
  "dash.stopping": "중지 중…",
  "dash.actions": "프록시",
  "dash.codexRestart": "Codex 재시작",
  "dash.codexRestarting": "재시작 중…",
  "dash.codexRestartConfirm": "Codex app-server를 재시작할까요? 진행 중인 Codex 작업이 끊깁니다.",
  "dash.codexRestartDone": "Codex app-server {count}개를 종료했습니다. Codex를 다시 열면 최신 모델 목록이 뜹니다.",
  ...
  "dash.codexRestartPartial": "app-server {count}개가 종료되지 않았습니다. 모델 목록이 계속 옛날 것이면 직접 종료하세요.",
