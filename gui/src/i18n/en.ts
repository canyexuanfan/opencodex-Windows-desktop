...
export const en = {
  ...
  "pws.rateLimits.documented": "Documented",
  "pws.rateLimits.rpm": "{value} req/min",
  "pws.rateLimits.tpm": "{value} tok/min",
  "pws.rateLimits.rpd": "{value} req/day",
  "pws.rateLimits.freeTier.local": "Local — no remote limits",
  "pws.rateLimits.freeTier.opencodeFree": "~200 free-model requests per 5 hours",
  "pws.rateLimits.freeTier.gemini": "Free tier: ~15 RPM / 250K TPM / 1K RPD (tier-dependent)",
  "pws.rateLimits.freeTier.groq": "Free tier: ~30 RPM / 6K TPM / 1K RPD",
  "pws.rateLimits.freeTier.sambanova": "Free tier: ~60 RPM / 100K TPM; then pay-as-you-go",
  "pws.rateLimits.freeTier.nebius": "Free tier: ~50 RPM / 50K TPM",
  "pws.rateLimits.freeTier.mistral": "Free tier: ~5 RPM / 20K TPM; then pay-as-you-go",
  "pws.rateLimits.freeTier.together": "Free tier: ~60 RPM / 1M TPM; then pay-as-you-go",
  "pws.rateLimits.freeTier.fireworks": "Free tier: ~600 RPM / 150K TPM",
  "pws.rateLimits.freeTier.openrouter": "Free models: ~20 req/min, credit-capped; paid per model",
  "pws.rateLimits.freeTier.minimax": "Coding plan subscription; per-plan quotas",
  "pws.rateLimits.freeTier.zai": "GLM coding subscription (paid plan)",
  "pws.rateLimits.freeTier.deepseek": "New accounts: one-time token grant; then pay-as-you-go",
