...
export const ja: Record<TKey, string> = {
  ...
  "models.contextHint": "このプロバイダーの実際の Codex ウィンドウです。上流が context_window / context_length を返さないときはこの値を使い、より大きな報告値があるときだけ下げます。空欄で自動検出に戻します。",
  ...
  "models.setAll": "すべて設定",
  "models.setAllHint": "{value} のコンテキスト上限をすべてのルーティング済みプロバイダーに適用します。中継がウィンドウを返さない場合、この値が実際の Codex ウィンドウになります。ネイティブプロバイダーには影響しません。",
