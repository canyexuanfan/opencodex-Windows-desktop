...
const CONNECTABLE: Record<string, ConnectableOverride> = {
  ...
  glm: openAi("https://api.z.ai/api/coding/paas/v4", "https://z.ai/manage-apikey/apikey-list", { supportLevel: "supported", verification: "official", documentationUrl: "https://docs.z.ai/guides/overview/quick-start", discovery: "static", liveModels: false, models: ["glm-5.2", "glm-5.1", "glm-5"] }),
  "glm-cn": openAi("https://open.bigmodel.cn/api/coding/paas/v4", "https://bigmodel.cn/apikey/platform", { supportLevel: "supported", verification: "official", documentationUrl: "https://docs.bigmodel.cn/cn/api/introduction", discovery: "static", liveModels: false, models: ["glm-5.2", "glm-5.1", "glm-5", "glm-4.7-flash"] }),
