...
export const ko: Record<TKey, string> = {
  ...
  "dash.start": "프록시 시작",
  "dash.starting": "시작 중…",
  "dash.startFailed": "프록시를 시작하지 못했습니다.",
  "dash.stop": "프록시 중지",
  "dash.externalManaged": "외부 CLI에서 관리",
  "dash.stopConfirm": "프록시를 중지하고 Codex 원본 설정을 복원할까요?",
  "dash.stopFailed": "프록시를 중지하지 못했습니다 (HTTP {status}).",
  "dash.stopping": "중지 중…",
  "dash.codexAutoStart": "Codex CLI 시작 시 프록시 확인",
  "dash.codexAutoStartHint": "설치된 CLI launcher shim이 ocx ensure를 실행하도록 허용합니다. 이 스위치는 shim을 설치하지 않으며 Codex Desktop 또는 직접 codex.exe 실행은 포함하지 않습니다. 시작 안전성에서 서비스/shim을 확인하세요.",
