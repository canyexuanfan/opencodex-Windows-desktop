...
env-reference, так что секрет остаётся в вашем окружении, а конфиги Pi, OMP, Kimi, Gajae и DSH несут
...
Сгенерированные интеграции Pi, OMP, Kimi, Gajae и DSH работают только через loopback. Как выдаются
