...
export const de = {
  ...
  "dash.col.provider": "Anbieter",
  "dash.col.models": "Modelle",
  "dash.col.sampleModels": "Beispielmodelle",
  "dash.modelsHint": "Die vollständige Liste und Modell-Schalter gibt es im Modelle-Tab.",
