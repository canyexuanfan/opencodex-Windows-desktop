...
export const ko: Record<TKey, string> = {
  ...
  "dash.syncCodexSubagentDefaultsHint": "위에서 고른 모델을 Codex 설정 파일에 써넣어, 새로 시작하는 Codex 작업이 그 모델로 출발하게 합니다. 다음 동기화나 재시작 때 반영되고, 직접 적어둔 [agents] 설정은 건드리지 않습니다. 기본은 꺼짐입니다.",
  "dash.multiAgentGuidance": "OpenCodex 멀티 에이전트 가이던스",
  "dash.multiAgentGuidanceHint": "일을 서브에이전트에게 어떻게 나눌지 알려주는 짧은 안내문을 프롬프트에 덧붙입니다. 나머지는 그대로입니다. v1/v2 표면, 서브에이전트 목록, 라우팅, effort 상한 모두 바뀌지 않습니다.",
