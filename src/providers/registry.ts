...
export const PROVIDER_REGISTRY: readonly ProviderRegistryEntry[] = [
  ...
  },
  {
    ...
    note: "Experimental Cursor bridge. Live transport and native read/write/delete/shell execution are enabled after a standalone PKCE browser login via 'ocx login cursor'.",
