...
export const de: Record<TKey, string> = {
  ...
  "storage.cleanup.quarantineNote": "Dateien wandern nach .trash unter CODEX_HOME. Wiederherstellen gibt es in dieser Version nicht — behalte den Ordner, bis du sicher bist.",
