/**
 * provider-workspace/documented-limits.ts — pure derivations for the
 * documented (reference) rate-limit display. No React, no fetch: kept out of
 * the component file so React Fast Refresh sees a component-only module.
 */
